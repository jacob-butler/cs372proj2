...
public:
	...
	std::string to_postscript() const;
	virtual std::string move_to_draw_position(int index, double & width, double & height) const = 0;
...
public:
	...
	~Layered() = default;
	std::string move_to_draw_position(int index, double & width, double & height) const override;
};
